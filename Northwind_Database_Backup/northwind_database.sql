...
-- Started on 2023-07-13 08:02:46 EDT
...
--
-- TOC entry 212 (class 1259 OID 16743)
...
-- Name: products_table; Type: TABLE; Schema: public; Owner: analyst
--
...
ALTER TABLE public.products_table OWNER TO analyst;
...
-- Name: suppliers_table; Type: TABLE; Schema: public; Owner: analyst
--

CREATE TABLE public.suppliers_table (
    supplier_id smallint,
    company_name character varying(40)
);


ALTER TABLE public.suppliers_table OWNER TO analyst;

--
-- TOC entry 225 (class 1259 OID 17281)
-- Name: suppliers_with_null_products; Type: TABLE; Schema: public; Owner: analyst
--

CREATE TABLE public.suppliers_with_null_products (
    supplier_id smallint,
    company_name character varying(40),
    contact_name character varying(30),
    contact_title character varying(30),
...
ALTER TABLE public.suppliers_with_null_products OWNER TO analyst;
...
--
-- TOC entry 4370 (class 0 OID 16730)
-- Dependencies: 209
...
--
-- TOC entry 4371 (class 0 OID 16735)
-- Dependencies: 210
...
--
-- TOC entry 4372 (class 0 OID 16738)
-- Dependencies: 211
...
--
-- TOC entry 4373 (class 0 OID 16743)
-- Dependencies: 212
...
--
-- TOC entry 4375 (class 0 OID 16751)
-- Dependencies: 214
...
--
-- TOC entry 4374 (class 0 OID 16746)
-- Dependencies: 213
...
--
-- TOC entry 4376 (class 0 OID 16754)
-- Dependencies: 215
...
--
-- TOC entry 4377 (class 0 OID 16757)
-- Dependencies: 216
...
--
-- TOC entry 4378 (class 0 OID 16760)
-- Dependencies: 217
-- Data for Name: products; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.products (product_id, product_name, supplier_id, category_id, quantity_per_unit, unit_price, units_in_stock, units_on_order, reorder_level, discontinued, product_cost) FROM stdin;
1	Chai	8	1	10 boxes x 30 bags	18	39	0	10	1	18.4
2	Chang	1	1	24 - 12 oz bottles	19	17	40	25	1	19.56
3	Aniseed Syrup	1	2	12 - 550 ml bottles	10	13	70	25	0	8.69
4	Chef Anton's Cajun Seasoning	2	2	48 - 6 oz jars	22	53	0	0	0	22.96
5	Chef Anton's Gumbo Mix	2	2	36 boxes	21.35	0	0	0	1	18.46
6	Grandma's Boysenberry Spread	3	2	12 - 8 oz jars	25	120	0	25	0	20.8
7	Uncle Bob's Organic Dried Pears	3	7	12 - 1 lb pkgs.	30	15	0	10	0	28.78
8	Northwoods Cranberry Sauce	3	2	12 - 12 oz jars	40	6	0	0	0	35.48
13	Konbu	6	8	2 kg box	6	24	0	5	0	6.13
9	Mishi Kobe Niku	4	6	18 - 500 g pkgs.	97	29	0	0	1	94.23
10	Ikura	4	8	12 - 200 ml jars	31	31	0	0	0	28.23
11	Queso Cabrales	5	4	1 kg pkg.	21	22	30	30	0	20.54
12	Queso Manchego La Pastora	5	4	10 - 500 g pkgs.	38	86	0	0	0	37.09
14	Tofu	6	7	40 - 100 g pkgs.	23.25	35	0	0	0	23.42
15	Genen Shouyu	6	2	24 - 250 ml bottles	13	39	0	5	0	12.36
44	Gula Malacca	20	2	20 - 2 kg bags	19.45	27	0	15	0	17.98
45	Rogede sild	21	8	1k pkg.	9.5	5	70	15	0	7.64
46	Spegesild	21	8	4 - 450 g glasses	12	95	0	0	0	10.1
47	Zaanse koeken	22	3	10 - 4 oz boxes	9.5	36	0	0	0	9.97
48	Chocolade	22	3	10 pkgs.	12.75	15	70	25	0	11.88
67	Laughing Lumberjack Lager	16	1	24 - 12 oz bottles	14	52	0	10	0	13.87
68	Scottish Longbreads	8	3	10 boxes x 8 pieces	12.5	6	10	15	0	10.92
70	Outback Lager	7	1	24 - 355 ml bottles	15	15	10	30	0	13.61
71	Flotemysost	15	4	10 - 500 g pkgs.	21.5	26	0	0	0	18.21
72	Mozzarella di Giovanni	14	4	24 - 200 g pkgs.	34.8	14	0	0	0	35.33
73	Röd Kaviar	17	8	24 - 150 g jars	15	101	0	5	0	13.18
74	Longlife Tofu	4	7	5 kg pkg.	10	4	20	5	0	10.47
75	Rhönbräu Klosterbier	12	1	24 - 0.5 l bottles	7.75	125	0	25	0	8.01
76	Lakkalikööri	23	1	500 ml	18	57	0	20	0	17.66
77	Original Frankfurter grüne Soße	12	2	12 boxes	13	32	0	15	0	12.4
16	Pavlova	7	3	32 - 500 g boxes	17.45	29	0	10	0	17.69
17	Alice Mutton	7	6	20 - 1 kg tins	39	0	0	0	1	33.38
18	Carnarvon Tigers	7	8	16 kg pkg.	62.5	42	0	0	0	52.73
19	Teatime Chocolate Biscuits	8	3	10 boxes x 12 pieces	9.2	25	0	5	0	8.76
20	Sir Rodney's Marmalade	8	3	30 gift boxes	81	40	0	0	0	79
21	Sir Rodney's Scones	8	3	24 pkgs. x 4 pieces	10	3	40	5	0	8.38
22	Gustaf's Knäckebröd	9	5	24 - 500 g pkgs.	21	104	0	25	0	17.45
23	Tunnbröd	9	5	12 - 250 g pkgs.	9	61	0	25	0	8.77
24	Guaraná Fantástica	10	1	12 - 355 ml cans	4.5	20	0	0	1	3.8
25	NuNuCa Nuß-Nougat-Creme	11	3	20 - 450 g glasses	14	76	0	30	0	14.09
26	Gumbär Gummibärchen	11	3	100 - 250 g bags	31.23	15	0	0	0	32.26
27	Schoggi Schokolade	11	3	100 - 100 g pieces	43.9	49	0	30	0	36.54
28	Rössle Sauerkraut	12	7	25 - 825 g cans	45.6	26	0	0	1	43.62
29	Thüringer Rostbratwurst	12	6	50 bags x 30 sausgs.	123.79	0	0	0	1	115.75
30	Nord-Ost Matjeshering	13	8	10 - 200 g glasses	25.89	10	0	15	0	26.46
31	Gorgonzola Telino	14	4	12 - 100 g pkgs	12.5	0	70	20	0	11.24
32	Mascarpone Fabioli	14	4	24 - 200 g pkgs.	32	9	40	25	0	27.76
34	Sasquatch Ale	16	1	24 - 12 oz bottles	14	111	0	15	0	11.49
35	Steeleye Stout	16	1	24 - 12 oz bottles	18	20	0	15	0	17.59
36	Inlagd Sill	17	8	24 - 250 g  jars	19	112	0	20	0	15.59
37	Gravad lax	17	8	12 - 500 g pkgs.	26	11	50	25	0	25.8
38	Côte de Blaye	18	1	12 - 75 cl bottles	263.5	17	0	15	0	249.46
39	Chartreuse verte	18	1	750 cc per bottle	18	69	0	5	0	15.91
40	Boston Crab Meat	19	8	24 - 4 oz tins	18.4	123	0	30	0	16.5
41	Jack's New England Clam Chowder	19	8	12 - 12 oz cans	9.65	85	0	10	0	9.79
42	Singaporean Hokkien Fried Mee	20	5	32 - 1 kg pkgs.	14	26	0	0	1	12.5
43	Ipoh Coffee	20	1	16 - 500 g tins	46	17	10	25	0	44.97
33	Geitost	15	4	500 g	2.5	112	0	20	0	2.45
49	Maxilaku	23	3	24 - 50 g pkgs.	20	10	60	15	0	20.84
50	Valkoinen suklaa	23	3	12 - 100 g bars	16.25	65	0	30	0	15.68
51	Manjimup Dried Apples	24	7	50 - 300 g pkgs.	53	20	0	10	0	51.45
52	Filo Mix	24	5	16 - 2 kg boxes	7	38	0	25	0	6.51
53	Perth Pasties	24	6	48 pieces	32.8	0	0	0	1	32.81
54	Tourtière	25	6	16 pies	7.45	21	0	10	0	7.34
55	Pâté chinois	25	6	24 boxes x 2 pies	24	115	0	20	0	24.68
56	Gnocchi di nonna Alice	26	5	24 - 250 g pkgs.	38	21	10	30	0	31.08
57	Ravioli Angelo	26	5	24 - 250 g pkgs.	19.5	36	0	20	0	17.13
58	Escargots de Bourgogne	27	8	24 pieces	13.25	62	0	20	0	13.1
59	Raclette Courdavault	28	4	5 kg pkg.	55	79	0	0	0	44.87
60	Camembert Pierrot	28	4	15 - 300 g rounds	34	19	0	0	0	35.68
61	Sirop d'érable	29	2	24 - 500 ml bottles	28.5	113	0	25	0	24.63
62	Tarte au sucre	29	3	48 pies	49.3	17	0	0	0	47.18
63	Vegie-spread	7	2	15 - 625 g jars	43.9	24	0	5	0	42.39
64	Wimmers gute Semmelknödel	12	5	20 bags x 4 pieces	33.25	22	80	30	0	29.25
65	Louisiana Fiery Hot Pepper Sauce	2	2	32 - 8 oz bottles	21.05	76	0	0	0	20.12
66	Louisiana Hot Spiced Okra	2	2	24 - 8 oz jars	17	4	100	20	0	14.48
69	Gudbrandsdalsost	15	4	10 kg pkg.	36	26	0	15	0	30.71
\.


--
-- TOC entry 4385 (class 0 OID 17278)
-- Dependencies: 224
-- Data for Name: products_table; Type: TABLE DATA; Schema: public; Owner: analyst
--

COPY public.products_table (product_id, product_name) FROM stdin;
1	Chai
2	Chang
3	Aniseed Syrup
...
--
-- TOC entry 4379 (class 0 OID 16763)
-- Dependencies: 218
...
--
-- TOC entry 4380 (class 0 OID 16766)
-- Dependencies: 219
...
7	 Carrier pidge-In 	(503) 333-9831
\.
...
--
-- TOC entry 4384 (class 0 OID 17275)
-- Dependencies: 223
-- Data for Name: suppliers_table; Type: TABLE DATA; Schema: public; Owner: analyst
--

COPY public.suppliers_table (supplier_id, company_name) FROM stdin;
1	Exotic Liquids
...
--
-- TOC entry 4386 (class 0 OID 17281)
-- Dependencies: 225
-- Data for Name: suppliers_with_null_products; Type: TABLE DATA; Schema: public; Owner: analyst
--

COPY public.suppliers_with_null_products (supplier_id, company_name, contact_name, contact_title, address, city, region, postal_code, country, phone, fax, homepage) FROM stdin;
\.


--
-- TOC entry 4382 (class 0 OID 16774)
-- Dependencies: 221
...
--
-- TOC entry 4383 (class 0 OID 16777)
-- Dependencies: 222
...
--
-- TOC entry 4191 (class 2606 OID 16788)
...
--
-- TOC entry 4193 (class 2606 OID 16790)
...
--
-- TOC entry 4195 (class 2606 OID 16792)
...
--
-- TOC entry 4197 (class 2606 OID 16794)
...
--
-- TOC entry 4201 (class 2606 OID 16798)
...
--
-- TOC entry 4199 (class 2606 OID 16796)
...
--
-- TOC entry 4203 (class 2606 OID 16800)
...
--
-- TOC entry 4205 (class 2606 OID 16802)
...
--
-- TOC entry 4207 (class 2606 OID 16804)
...
--
-- TOC entry 4209 (class 2606 OID 16806)
...
--
-- TOC entry 4213 (class 2606 OID 16810)
...
--
-- TOC entry 4215 (class 2606 OID 16812)
...
--
-- TOC entry 4217 (class 2606 OID 16814)
...
--
-- TOC entry 4218 (class 2606 OID 16865)
...
--
-- TOC entry 4219 (class 2606 OID 16870)
...
--
-- TOC entry 4221 (class 2606 OID 16860)
...
--
-- TOC entry 4222 (class 2606 OID 16855)
...
--
-- TOC entry 4220 (class 2606 OID 16875)
...
--
-- TOC entry 4223 (class 2606 OID 16835)
...
--
-- TOC entry 4224 (class 2606 OID 16830)
...
--
-- TOC entry 4225 (class 2606 OID 16815)
...
--
-- TOC entry 4226 (class 2606 OID 16820)
...
--
-- TOC entry 4227 (class 2606 OID 16825)
...
--
-- TOC entry 4228 (class 2606 OID 16840)
...
--
-- TOC entry 4229 (class 2606 OID 16845)
...
--
-- TOC entry 4230 (class 2606 OID 16850)
...
GRANT SELECT ON TABLE public.categories TO analyst;
...
GRANT SELECT ON TABLE public.customer_customer_demo TO analyst;
...
GRANT SELECT ON TABLE public.customer_demographics TO analyst;
...
GRANT SELECT ON TABLE public.employee_territories TO analyst;
...
GRANT SELECT ON TABLE public.order_details TO analyst;
...
GRANT SELECT ON TABLE public.products TO analyst;
...
GRANT SELECT ON TABLE public.region TO analyst;
...
GRANT SELECT ON TABLE public.shippers TO analyst;
...
GRANT SELECT ON TABLE public.suppliers TO analyst;
...
GRANT SELECT ON TABLE public.territories TO analyst;
...
GRANT SELECT ON TABLE public.us_states TO analyst;


-- Completed on 2023-07-13 08:02:47 EDT
